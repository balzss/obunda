...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t-2 border-border font-base text-main-foreground last:[&>tr]:border-b-0",
        className,
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b-2 border-border transition-colors text-main-foreground bg-white font-base data-[state=selected]:bg-secondary-background data-[state=selected]:text-main-foreground",
        className,
      )}
      {...props}
    />
